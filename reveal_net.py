...
def reveal_net(container):
    ...
    conv1_1 = Conv2D(filters=32, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        container)
    conv1_2 = Conv2D(filters=32, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv1_1)
    conv1_3 = Conv2D(filters=32, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv1_2)
    conv1_4 = Conv2D(filters=32, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv1_3)
    conv1_5 = Conv2D(filters=32, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv1_4)
    ...
    conv2_1 = Conv2D(filters=64, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        maxpool1)
    conv2_2 = Conv2D(filters=64, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv2_1)
    conv2_3 = Conv2D(filters=64, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv2_2)
    conv2_4 = Conv2D(filters=64, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv2_3)
    conv2_5 = Conv2D(filters=64, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv2_4)
    ...
    v10 = Conv2D(filters=64, kernel_size=3, padding='same', activation=tf.nn.relu, data_format='channels_last')(
        conv10_5)
...
container = tf.placeholder(shape=input_shape, dtype=tf.float32, name='container')   
